...
class Movie extends BaseEntities_1.BaseEntities {
    constructor() {
        super(...arguments);
        this.isHot = false;
        this.isComing = false;
...
exports.Movie = Movie;
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: '电影名称不可以为空' }),
    (0, class_validator_1.MaxLength)(10, { message: '电影名称长度不可以超过10' }),
    (0, class_validator_1.MinLength)(2, { message: '电影名称长度不可以少于2' }),
    (0, class_transformer_1.Type)(() => String),
    __metadata("design:type", String)
], Movie.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: '电影类型不可以为空' }),
    (0, class_validator_1.ArrayMinSize)(1, { message: '电影类型长度至少有一个' }),
    (0, class_transformer_1.Type)(() => String),
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => String),
    (0, class_validator_1.IsArray)({ message: '上映地区必须是数组' }),
    __metadata("design:type", Array)
], Movie.prototype, "areas", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: '时长不可以为空' }),
    (0, class_validator_1.IsInt)({ message: '时长必须是整数' }),
    (0, class_validator_1.Min)(1, { message: '时长必须大于1分钟' }),
    (0, class_validator_1.Max)(2000, { message: '时长必须小于2000分钟' }),
